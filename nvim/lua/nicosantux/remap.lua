...
keymap.set("n", "<leader>sp", "<cmd>vertical resize +10<CR>", { desc = "Increase vertical split" })
keymap.set("n", "<leader>sm", "<cmd>vertical resize -10<CR>", { desc = "Decrease vertical split" })
